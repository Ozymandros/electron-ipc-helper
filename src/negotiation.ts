 ...
 * @module negotiation
 *
 * Capability negotiation ("handshake") system for @ozymandros/electron-message-bridge adapters.
 *
...
export interface AdapterManifest {
   ...
   * @example `'@ozymandros/electron-message-bridge-adapter-assemblyscript'`
   */
