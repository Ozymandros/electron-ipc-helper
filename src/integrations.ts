 ...
 *
 * Import from `@ozymandros/electron-message-bridge/integrations` when you want ready-made
...
export function registerDialogHandlers(
  ...
  ipcMain.handle(messageBoxChannel, async (_event, options: unknown) => {
    if (
      ...
      throw new TypeError(
        `[@ozymandros/electron-message-bridge] ${messageBoxChannel} requires an options object with a string \"message\" property.`,
      );
    }
