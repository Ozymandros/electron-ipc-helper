/**
 * Lazy-loader shim for `@ozymandros/electron-message-bridge-adapter-grpc`.
 *
 ...
 * @example
 * ```ts
 * import { loadGrpcAdapter } from '@ozymandros/electron-message-bridge/adapters/grpc';
 *
...
import type * as GrpcAdapterModule from '@ozymandros/electron-message-bridge-adapter-grpc';
...
export type {
  ...
  InvokeRequest,
  InvokeResponse,
} from '@ozymandros/electron-message-bridge-adapter-grpc';
 ...
 *
 * Throws `AdapterMissingError` if `@ozymandros/electron-message-bridge-adapter-grpc` is not
...
export function loadGrpcAdapter(): Promise<typeof GrpcAdapterModule> {
  return requireAdapter(
    ...
    () => import('@ozymandros/electron-message-bridge-adapter-grpc'),
  );
}
