 ...
 * ```
 *
 * @see https://github.com/your-org/@ozymandros/electron-message-bridge/blob/main/docs/migration.md
 ...
 * ```ts
 * import { loadAssemblyScriptAdapter } from '@ozymandros/electron-message-bridge/adapters/assemblyscript';
 * import { AdapterMissingError }       from '@ozymandros/electron-message-bridge';
 *
 * try {
