/**
 * Lazy-loader shim for `@ozymandros/electron-message-bridge-adapter-named-pipe`.
 *
 ...
 * @example
 * ```ts
 * import { loadNamedPipeAdapter } from '@ozymandros/electron-message-bridge/adapters/named-pipe';
 *
...
import type * as NamedPipeAdapterModule from '@ozymandros/electron-message-bridge-adapter-named-pipe';
...
} from '@ozymandros/electron-message-bridge-adapter-named-pipe';
 ...
 *
 * Throws `AdapterMissingError` if `@ozymandros/electron-message-bridge-adapter-named-pipe`
...
export function loadNamedPipeAdapter(): Promise<typeof NamedPipeAdapterModule> {
  return requireAdapter(
    ...
    () => import('@ozymandros/electron-message-bridge-adapter-named-pipe'),
  );
}
