...
describe('scaffold: minimal template', () => {
  ...
  it('generates valid package.json with correct name', async () => {
    ...
    expect(pkg.dependencies?.['@ozymandros/electron-message-bridge']).toBeDefined();
  ...
  it('creates api.ts in src/', async () => {
    ...
    expect(api).toContain('@ozymandros/electron-message-bridge');
  });
  ...
  it('creates preload.ts in src/', async () => {
    ...
    expect(preload).toContain('@ozymandros/electron-message-bridge/preload');
  });
...
describe('scaffold: full template', () => {
  ...
  it('lifecycle.ts uses ChildProcessLifecycle', async () => {
    ...
    expect(lc).toContain('@ozymandros/electron-message-bridge/lifecycle');
  });
