...
export default defineConfig({
  test: {
    ...
    alias: {
      ...
      '@ozymandros/electron-message-bridge-adapter-grpc': new URL('./packages/adapter-grpc/src/index.ts', bridgeRoot).pathname,
      '@ozymandros/electron-message-bridge-adapter-stdio': new URL('./packages/adapter-stdio/src/index.ts', bridgeRoot).pathname,
      '@ozymandros/electron-message-bridge/plugins': new URL('./src/plugins.ts', bridgeRoot).pathname,
