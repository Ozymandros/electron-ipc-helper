...
var __vite_injected_original_import_meta_url = "file:///sessions/beautiful-clever-johnson/mnt/electron-ipc-helper/vitest.config.ts";
var vitest_config_default = defineConfig({
  test: {
    ...
    alias: {
      ...
      "electron-ipc-helper/plugins": new URL("./src/plugins.ts", __vite_injected_original_import_meta_url).pathname,
      "electron-ipc-helper/transport": new URL("./src/transport.ts", __vite_injected_original_import_meta_url).pathname,
      "electron-ipc-helper/boundary": new URL("./src/boundary.ts", __vite_injected_original_import_meta_url).pathname,
      "electron-ipc-helper": new URL("./src/index.ts", __vite_injected_original_import_meta_url).pathname
    },
    typecheck: {
