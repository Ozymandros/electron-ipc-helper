...
The ozymandros/electron-message-bridge maturity model describes the progression from experimental feature to long-term stable support. Each module and the framework as a whole moves through these stages:
