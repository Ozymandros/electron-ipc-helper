...
Objective: evolve ozymandros/electron-message-bridge from a typed IPC utility library into a framework-grade platform with opinionated architecture, strong DX, plugin extensibility, release safety, and performance/security quality gates.
